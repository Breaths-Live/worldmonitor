...
/**
 * Fallback data when WTO API is unavailable (missing API key or network error).
 */
function getFallbackRestrictions(limit: number): TradeRestriction[] {
  return [
    {
      id: 'chn-2025-tp-a-0010',
      reportingCountry: 'China',
      affectedCountry: 'All trading partners',
      productSector: 'All products',
      measureType: 'MFN Applied Tariff',
      description: 'Average tariff rate: 12.4%',
      status: 'high',
      notifiedAt: '2025',
      sourceUrl: 'https://stats.wto.org',
    },
    {
      id: 'ind-2025-tp-a-0010',
      reportingCountry: 'India',
      affectedCountry: 'All trading partners',
      productSector: 'All products',
      measureType: 'MFN Applied Tariff',
      description: 'Average tariff rate: 10.8%',
      status: 'high',
      notifiedAt: '2025',
      sourceUrl: 'https://stats.wto.org',
    },
    {
      id: 'usa-2025-tp-a-0010',
      reportingCountry: 'United States',
      affectedCountry: 'All trading partners',
      productSector: 'All products',
      measureType: 'MFN Applied Tariff',
      description: 'Average tariff rate: 4.2%',
      status: 'moderate',
      notifiedAt: '2025',
      sourceUrl: 'https://stats.wto.org',
    },
...
export async function getTradeRestrictions(
  ...
  try {
    ...
    return {
      restrictions: getFallbackRestrictions(limit),
      fetchedAt: new Date().toISOString(),
      upstreamUnavailable: true,
    };
  } catch {
    return {
      restrictions: getFallbackRestrictions(Math.min(req.limit > 0 ? req.limit : 50, 100)),
      fetchedAt: new Date().toISOString(),
      upstreamUnavailable: true,
    };
  }
